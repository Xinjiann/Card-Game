...
public class CommandDemo {
	...
	public static void executeDemo(ActorRef out) {
		...
		CommonUtils.longlongSleep(2000); // these cause processing to wait for a number of milliseconds.
		...
		CommonUtils.longlongSleep(3000);
		...
		CommonUtils.longlongSleep(1000);
